...
ADMIN = int(os.environ.get("ADMIN", 6245042947))
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/MAPOriginal")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/Movie_fo'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/movie_file_20')],
            ...
            try:
                ...
                await message.reply_photo(photo=LAZY_PIC,
                                         ...
                                         reply_markup=InlineKeyboardMarkup(
                                             [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/MAPOriginal")],
                                              [InlineKeyboardButton("🦋 Subscribe us 🦋", url="")],
                                              [InlineKeyboardButton("Support Group", url='https://Movie_fo'),
                                             InlineKeyboardButton("Movie Channel", url='https://t.me/movie_file_20')],
                                             [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='')]
                                          ]))
            except:
	...
	""", reply_to_message_id=message.id,
                                     reply_markup=InlineKeyboardMarkup(
                                         [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/MAPOriginal")],
                                          [InlineKeyboardButton("🦋 Subscribe us 🦋", url="")],
                                          [InlineKeyboardButton("Support Group", url='https://t.me/Movie_fo'),
                                          InlineKeyboardButton("Movie Channel", url='https://t.me/Movie_fo')],
                                          [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='')]
                                          ]))
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact LazyDeveloper 🦋", url='https://telegram.me/MAPOriginal')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/Movie_fo'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://t.me/movie_file_20')],
                                                                     [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
        return 
